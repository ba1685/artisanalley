...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center bg-[#FAF9F6] font-sans text-stone-800">
      ...
      <nav 
        className="flex w-full flex-col md:flex-row items-center justify-between px-6 md:px-10 py-6 md:py-8 bg-[#FAF9F6]/80 backdrop-blur-md sticky top-0 z-50 gap-4 md:gap-0"
        data-cur="cursor"
      >
        ...
        <div className="flex gap-4 md:gap-8 text-[10px] md:text-xs font-medium uppercase tracking-widest text-stone-500">
          ...
          <Link href="/makers/" className="hover:text-stone-900 transition underline-offset-4 hover:underline">The Makers</Link>
          <Link href="/story" className="hover:text-stone-900 transition underline-offset-4 hover:underline">Story</Link>
        </div>
      </nav>

      <main 
        className="flex flex-1 flex-col items-center justify-center px-6 md:px-8 text-center max-w-4xl w-full py-16 md:py-24"
        data-cur="cursor"
      >
        <div className="flex flex-col gap-6 md:gap-8 items-center">
          <span className="text-[9px] md:text-[10px] font-bold tracking-[0.2em] md:tracking-[0.3em] text-stone-400 uppercase">
           NHITM Comp-A Group 2
          </span>
      ...
      {/* Footer */}
      <footer className="w-full py-10 md:py-12 px-6 text-center text-[9px] md:text-[10px] tracking-widest text-stone-400 uppercase leading-loose border-t border-stone-200">
